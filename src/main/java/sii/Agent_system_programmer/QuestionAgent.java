...
public class QuestionAgent extends Agent {
    ...
    protected void setup() {
        ...
        System.out.println("Задача " + getLocalName()+ " готова!");
                ...
                if (msg != null)
                {
                    ...
                    else
                    {
                        if (msg.getPerformative() == ACLMessage.ACCEPT_PROPOSAL && !isBusy)
                        {
                            ...
                            myAgent.send(reply);
                            System.out.println("Задача " + myAgent.getLocalName() + "(" + q.toString() + ")" + " выбрана программистом " + msg.getSender().getLocalName());
